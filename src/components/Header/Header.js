...
import logo_index from "../../assets/img/logo_index.svg";

const Header = () => {
  return (
    <header className="header center">
      <div className="header__left">
        <Link to="/" className="logo_index">
          <img src={logo_index} alt="logo_index" />
        </Link>
        <a href="#" className="logo_loupe">
          <svg
            width="26"
            height="27"
            viewBox="0 0 26 27"
      ...
      <div className="header__right">
        <div className="burger_menu">
          ...
          <input id="burger" type="checkbox" defaultChecked />
          <nav className="nav">
        ...
        <Link to="/registration" className="logo_person">
          <svg
            width="29"
            height="29"
            viewBox="0 0 29 29"
        ...
        <Link to="/cart" className="logo_cart">
          <svg
            width="32"
            height="29"
            viewBox="0 0 32 29"
